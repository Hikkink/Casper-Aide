...
public class Config
{
    ...
    public boolean HALLOWEEN = false, NOEL = true; // Eventos
    ...
    public int limitByIp = 0; // 0 = desactivado, 1+ = máximo de cuentas por IP
    ...
    public boolean allZaap = true, allEmote = true; // Opciones iniciales
    public int startLevel = 1, startKamas = 0;
    public int startMap = 0, startCell = 0; // Si es 0 usa ubicaciones iniciales por clase
    ...
    public int starHour = 1; // Horas para que un mob gane una estrella
    public int AIDelay = 50, AIMovementCellDelay = 50, AIMovementFlatDelay = 50, craftDelay = 10, gameActionDelay = 5; // Delays en ms
    public int weaponBonusBase = 80, primaryWeaponBonus = 30, secondaryWeaponBonus = 20, daggerSwordNerf = 5; // Bonos de armas
    public String lessDurationSpells = ",16,20,95,98,148,149,577,612,741,760,811,813,962,1004,1092,1122,1129,1143,2079,2081,53,170,1164,1169,1172,2118,";
    public int erosion = 10;
    public int basePods = 5000;

    /** Temporizadores */
    public int idleTime = 1000 * 60 * 30; // 30 minutos
    public int idleCheck = 1000 * 60 * 5; // 5 minutos
    public int starUpdate = 1000 * 60 * 15; // Actualiza estrellas cada 15 minutos
    public int averagePingUpdate = 1000 * 60 * 10; // 10 minutos
    public int moveEntityUpdate = 1000 * 60 * 5; // 5 minutos
    public int mountUpdate = 1000 * 35; // 35 segundos
    public int worldSaveUpdate = 1000 * 60 * 60 * 3; // 3 horas
    public int Worldvote = 1000 * 60 * 7; // 7 minutos
    public int World_kick_threads = 1000 * 60 * 1; // 1 minuto
    public int World_kick_Hikaricp = 1000 * 60 * 5; // 5 minutos
    public int Fight_anti_bug = 1000 * 5 * 1; // 5 segundos
    public int Session_kick = 1000 * 10 * 1; // 10 segundos
    public int Reboot = 1000 * 60 * 50; // 50 minutos
    public int Bandit = 1000 * 60 * 61; // 61 minutos
    public int worldMarket = 10111; // ID del mapa del mercado mundial

    /** Mapas y teletransportes */
    ...
    public String Ip; // IP del servidor
    ...
    public void set() {
        ...
        try {
            ...
            Config.getInstance().startLevel = Config.configFile.getInt("game.start_level");
            Config.getInstance().startKamas = Config.configFile.getInt("game.start_kamas");
            ...
            Config.getInstance().limitByIp = Config.configFile.getInt("system.server.game.limitByIp");
        }
        catch (Exception e) {
